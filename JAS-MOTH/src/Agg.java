  ...
  String c4;
   ...
   // Lineitem= Lineitem.aggregate(Aggregations.MAX,0).first(1);
       ...
       //.groupBy(0);//aggregate(Aggregations.SUM, 1).groupBy(0);
        ...
        Lineitem1.writeAsCsv("/home/hadoop/Desktop/Flink/Dataset/PlainResults/agg.csv", "\n", ",",WriteMode.OVERWRITE).setParallelism(1);
       env.execute();
...
public static  Tuple  get_Partsupp()
       ...
       DataSet<Lineitem> Lineitem=(DataSet<Lineitem>) env.readCsvFile("/home/hadoop/Desktop/Flink/Dataset/PlainResults/t6.csv")
      .fieldDelimiter(',')
      .includeFields(mask).ignoreFirstLine()
