...
public class TPCHQuery3 {
	...
	public static void main(String[] args) throws Exception {
                args=new String[]{"/home/hadoop/Desktop/Dataset1/lineitem.csv","/home/hadoop/Desktop/Dataset1/customer.csv","/home/hadoop/Desktop/Dataset1/orders.csv","/home/hadoop/Desktop/Dataset1/out.csv"};
		...
		DataSet<Customer> customers = getCustomerDataSet(env);
                ...
                customers.join(orders).where(0).equalTo(0)
                        .with(
                    new JoinFunction<Customer, Order, ShippingPriorityItem>() {
                @Override
                public ShippingPriorityItem join(Customer c, Order o) {
                 return new ShippingPriorityItem(o.getOrderKey(), 0.0, 
                         o.getOrderdate(),o.getCustKey());
                                }
                        });
	...
	public static class ShippingPriorityItem extends Tuple4<Integer, Double, String, Integer> {
		...
		public ShippingPriorityItem(Integer o_orderkey, Double revenue,String o_orderdate, Integer o_shippriority) {
			this.f0 = o_orderkey;
			this.f1 = revenue;
			this.f2 = o_orderdate;
	...
	private static boolean parseParameters(String[] programArguments) {
		System.out.print("arg : "+programArguments.length);
	...
	private static DataSet<Customer> getCustomerDataSet(ExecutionEnvironment env) {
		return env.readCsvFile(customerPath)
					.fieldDelimiter('|').ignoreFirstLine()
