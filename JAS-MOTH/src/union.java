...
// end q1
  ...
  DataSet<Lineitem> Lineitem2= getLineitemDataSet(env,maskorder,Q.input_file_name,Q.fieldDelimiter);  
 // Lineitem2.union(Lineitem1);
...
// end q1
       ...
       public static  Tuple  get_lineitem()
        ...
        public static class Lineitem extends Tuple5<Double,Double,String,String,String> implements lineitem {
       ...
       DataSet<Lineitem> Lineitem = null;
         ...
         Lineitem=(DataSet<Lineitem>) env.readCsvFile(input_file_name)
...
public static void Print_multi_query_plan_Report( )
{
   ...
   for(int i=start_query_num; i<total_query_num; i++)
   {
       String s="Runtime of Query"+ (i+1)+"  "+multi_query[i].quey_run_time;
...
//fill multi-query 
 ...
 //System.out.println("ParentQuery"+Query_content[0]);
   ...
   multi_query[i].input_file_name=DataPath+Query_line_content[1].trim()+".csv";
   Query_line_content=Query_content[1].split("=");
   multi_query[i].output_file_name=DataPath+Query_line_content[1].trim()+".csv";
  ...
  // System.out.println("Query_content[7] "+Query_content[7]);
   //fill columnslist
   for(int j=1;j<columnslist.length-1;j++)
 //System.out.println("Q1_Parent_name.."+Query_line_content[1]);
